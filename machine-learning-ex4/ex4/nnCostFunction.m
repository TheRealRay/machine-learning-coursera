...
eye_k = eye(num_labels); % 10 x 10

y_matrix = eye_k(y, :); % 5000 x 10
...
for i = 1:m
    ia1 = X(i, :)'; % 401 x 1
    iz2 = Theta1 * ia1; % 25 x 1
    ia2 = sigmoid(iz2); % 25 x 1
    ia2 = [1;ia2]; % 26 x 1
    iz3 = Theta2 * ia2; % 10 x 1
    ia3 = sigmoid(iz3); % 10 x 1
    
    y_vector = y_matrix(i, :)'; % 10 x 1
    
    d_3 = ia3 - y_vector; % 10 x 1
    d_2FirstPart =  Theta2' * d_3; % 26 x 1
    d_2 = d_2FirstPart(2:end)  .* sigmoidGradient(iz2); % 25 x 1
    
    D_2 = D_2 + d_3 * ia2'; % 10 x 26
    D_1 = D_1 + d_2 * ia1'; % 25 x 401
end
